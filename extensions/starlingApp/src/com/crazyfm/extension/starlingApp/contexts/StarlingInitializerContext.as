 ...
 */
package com.crazyfm.extension.starlingApp.contexts
{
	...
	import com.crazyfm.extension.starlingApp.initializer.messages.StarlingInitializerMessageEnum;
	 ...
	 */
	public class StarlingInitializerContext extends AbstractContext
	{
		...
		{
			dispatchMessage(StarlingInitializerMessageEnum.STARLING_INITIALIZED);
		}
