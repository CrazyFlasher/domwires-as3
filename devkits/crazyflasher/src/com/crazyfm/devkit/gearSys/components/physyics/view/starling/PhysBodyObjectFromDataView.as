 ...
 */
package com.crazyfm.devkit.gearSys.components.physyics.view.starling
{
	...
	public class PhysBodyObjectFromDataView extends AbstractPhysBodyObjectView
	{
		...
		public function PhysBodyObjectFromDataView(shapesDataList:Vector.<ShapeDataVo>, color:uint = 0x666666)
		{
			super();
